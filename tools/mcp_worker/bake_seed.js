...
export const DOC = {
  ...
  coaching: "coaching/{season}/{TEAM} → formations (personnel/alignment, route assignments per slot) and views (usage, pass rate, EPA and run lanes by formation group); the season in progress is charted sets (charting_only: true) — personnel from last season's habits (pers_assumed), routes estimated from target zones (assign src: inf) until the participation file publishes",
