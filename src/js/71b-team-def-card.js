...
async function pcardFetchDstSeason(season){
  // An in-progress season only has weeks up to the last completed one; asking for the rest
  // wastes 12 round trips and (in a frozen build) would leak weeks that "haven't happened".
  const maxWk = (typeof tcSeasonMaxWeek==='function') ? tcSeasonMaxWeek(season) : 18;
