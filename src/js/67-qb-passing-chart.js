...
function renderPcardQbPassing(pid){
  ...
  return `<div class="qpc-wrap">
    ...
    <div class="qpc-totals">
      ...
      <div class="qpc-tile" title="Located pass attempts (excludes sacks &amp; 2-pt)"><label>Attempts</label><b>${noteWrapHtml(escHtml(t.attempts!=null?t.attempts:'—'), { label:'Located Attempts', value:t.attempts!=null?t.attempts:'—', source:'qb_passing_chart', statKey:'attempts', context:`${season} passing chart`, player:notePlayer, team:notePlayer.team }, 'note-tag-hit')}</b></div>
    </div>
