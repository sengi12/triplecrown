...
chk(/<th[^>]*>Under pressure<\/th><td>1\/5<\/td><td class="dz-pct">20%<\/td><td>9<\/td><td>0<\/td><td>1<\/td><td>3<\/td><td><b>2\.5<\/b>/.test(h), 'under pressure: 1/5, 20%, 9 yds, 0 TD, 1 INT, 3 sacks, rating 2.5');
chk(/Clean pocket<\/th><td>16\/22/.test(h) && /vs Blitz \(5\+\)<\/th><td>5\/8/.test(h), 'the clean and vs-blitz lines');
chk(/PFR pressures <b>6<\/b> <span class="qpc-dz-pct">\(18\.8% of dropbacks\)<\/span> · blitzed <b>9<\/b> · hurried <b>0<\/b> · hit <b>3<\/b> · sacked <b>3<\/b> · bad throws <b>4<\/b> · drops <b>2<\/b>/.test(h), 'PFR\'s pressure line with its own pressure rate');
h=app.panel(g2,[g1,g2],'2026',np);
chk(/qpc-dz-none"><th[^>]*>Under pressure<\/th><td colspan="7">none<\/td>/.test(h) && /PFR's pressure counts \(hurries included\) post within a day/.test(h), 'a game with no pressured dropback says none; PFR not posted yet says so');
...
chk(/PFR pressures <b>6<\/b> <span class="qpc-dz-pct">\(9\.7% of dropbacks\)/.test(h), 'PFR counts summed over the games that have them, the rate over our dropbacks');
