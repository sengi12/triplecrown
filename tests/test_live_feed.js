...
(async()=>{
  ...
  chk(/lf-live on">1 live/.test(hf) && /class="tc-fresh"/.test(hf) && /tc-fresh-t">(just now|\d+s ago)</.test(hf), 'with a game on, the feed\'s head carries the freshness stamp beside the live count');
