...
chk(/\.sr-table-wrap\{[^}]*overscroll-behavior-x:none;touch-action:pan-x pan-y/.test(html), 'league-wide Advanced table: axis-specific overscroll containment (the shorthand also blocks vertical scroll-chaining out of this accidental empty vertical scroller — see 00-base.css)');
