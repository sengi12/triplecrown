...
chk(/thead tr:nth-child\(1\) th:nth-child\(1\),[\s\S]{0,200}?z-index:[5-9]/.test(html),'WK header above both axes');
chk(/thead tr:nth-child\(1\) th:nth-child\(2\),[\s\S]{0,200}?z-index:[5-9]/.test(html),'OPP header above both axes');
